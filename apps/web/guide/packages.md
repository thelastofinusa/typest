...
| Package                          | Description                                                                               |
| -------------------------------- | ----------------------------------------------------------------------------------------- |
| [`@typest/vite`](/packages/vite) | Vite plugin – works with React, Vue, Svelte, and every Vite‑based project.                |
| [`@typest/core`](/packages/core) | Scanner, code generator, and file watcher. The engine used by all framework integrations. |
| `@typest/next`                   | _(coming soon)_                                                                           |

## Which package should I install?

- **I use Vite** → install `@typest/vite`, add the plugin to `vite.config.ts`.
- **I use Next.js** → install `@typest/next`, add the plugin to `next.config.ts`.
...
For a deep dive into the core API, check out the [`core documentation`](/packages/core).
